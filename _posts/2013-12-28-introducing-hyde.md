...
* [DorkScraper](https://github.com/robotshell/dorkSraper): DorkScraper is a simple tool written in Python to extract all the urls that appear when using a Google Dork.
